...
SCORES = os.environ.get("REL_SCORES_DIR", "results/exp1/reliability/reliability_scores")
SUBSET = os.environ.get("REL_SUBSET_DIR", "results/exp1/reliability/reliability_subset")
