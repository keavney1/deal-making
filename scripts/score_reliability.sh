...
#   e.g. scripts/score_reliability.sh results/reliability_subset_v4 response results/reliability_scores_v4
#        scripts/score_reliability.sh results/reliability_subset_v4 cot results/reliability_scores_v4_cot \
