...
Full CoT diagnosis history + per-field rationale: `results/exp1/reliability/cot_reliability_findings.md`.
...
full rationale in `results/exp1/reliability/cot_reliability_findings.md`:
...
- Scripts: `build_reliability_subset.py`, `rubric_agreement.py`, `rubric_disagreements.py`,
  `run_reliability*.sh`.
- Data: `results/exp1/reliability/reliability_subset{,_v2,_v3}/`, `results/exp1/reliability/reliability_scores{,_v2,_v3}/`.
- CoT findings: `results/exp1/reliability/cot_reliability_findings.md`.
