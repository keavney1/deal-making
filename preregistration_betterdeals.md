# Preregistration — Do better deals make misaligned models disclose misalignment?

**Status: DRAFT — not yet registered.** Items marked ⚠️ are decisions to settle before posting.
Once an OSF registration is approved it can never be edited.
